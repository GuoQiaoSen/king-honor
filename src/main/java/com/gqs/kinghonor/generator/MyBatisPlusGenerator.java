package com.gqs.kinghonor.generator;
...
public class MyBatisPlusGenerator {
    ...
    //要生成的表名
    private static final String[] TABLES= {"g_hero","g_hero_restrain"};
    private static final String JDBC_URL = "jdbc:mysql://123.57.84.93:3306/gok?useUnicode=true&characterEncoding=UTF-8" +
            "&useSSL=false&zeroDateTimeBehavior=convertToNull&";
    private static final String JDBC_DRIVER = "com.mysql.jdbc.Driver";
    private static final String JDBC_USERNAME = "root";
    private static final String JDBC_PASSWORD = "guoqiaosen.";
    private static final String BASE_PACKAGE = "com.gqs.kinghonor";
    ...
    private static void configGlobal(AutoGenerator generator, String projectPath) {
        ...
        globalConfig.setEntityName("%sDB");
    ...
    private static void configPackage(AutoGenerator generator) {
        ...
        packageConfig.setEntity("model.db");
